...
## Ambiente
- Host canônico (origem do navegador): `https://gestorcred-preview-2.preview.emergentagent.com`
- Alias (job id): `https://gestorcred-preview-2.preview.emergentagent.com`
