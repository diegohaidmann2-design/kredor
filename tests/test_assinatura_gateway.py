...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://credito-concluido.preview.emergentagent.com')
    ...
    def test_checkout_mercadopago_quando_desabilitado(self):
        ...
        response = requests.post(
            ...
            json={
                ...
                "senha": "test123456",
                "origin_url": "https://credito-concluido.preview.emergentagent.com",
