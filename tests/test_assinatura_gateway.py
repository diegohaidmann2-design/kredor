...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://payment-recognize.preview.emergentagent.com')
    ...
    def test_checkout_mercadopago_quando_desabilitado(self):
        ...
        response = requests.post(
            ...
            json={
                ...
                "senha": "test123456",
                "origin_url": "https://payment-recognize.preview.emergentagent.com",
