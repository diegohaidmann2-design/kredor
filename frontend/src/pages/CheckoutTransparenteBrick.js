          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-500 to-emerald-600 flex items-center justify-center shadow-lg">
                <span className="text-lg font-bold text-white">JF</span>
              </div>
              <span className="text-xl font-bold">
                <span className="text-emerald-500">Juro</span>Fácil
              </span>
            </div>
            <button
              onClick={() => navigate('/landing')}
                ...
                pagamentoAprovado ? (
                  ...
                  <div className="text-center space-y-6 py-8">
                    ...
                    <div className="bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 px-6 py-4 rounded-xl">
                      <p className="text-lg font-semibold">🎉 Bem-vindo ao Gestor Cred!</p>
