...
const Seguranca = () => (
  <CommercialLanding
    seo={{
      title: 'Segurança e proteção de dados (LGPD) | GestorCred',
      description: 'Saiba como o GestorCred protege seus dados: criptografia, controle de acesso e boas práticas de segurança, com respeito à LGPD. Seus dados e os dos seus clientes seguros.',
      path: '/seguranca',
    }}
    eyebrow="Segurança e privacidade"
    h1="Segurança dos seus dados e conformidade com a LGPD"
    subtitle="Trabalhar com crédito exige responsabilidade com dados. O GestorCred adota criptografia, controle de acesso e boas práticas para proteger as informações da sua carteira."
    heroBullets={[
    ...
    blocks={[
      ...
      { icon: ShieldCheck, title: 'Uso responsável', text: 'O GestorCred é um software de gestão. A consulta de dados serve à análise de crédito — nunca à perseguição de pessoas.' },
    ]}
    differentials={[
    ...
    faq={[
      ...
      { q: 'O GestorCred é compatível com a LGPD?', a: 'Adotamos princípios da LGPD, como finalidade e minimização. A consulta de dados é usada para validação e análise de crédito. Veja a Política de Privacidade para detalhes.' },
