    ...
    <Layout>
      <div className="container mx-auto px-4 sm:px-6 py-8 font-satoshi">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8 gap-4">
          <div>
            <h1 className="font-cabinet font-black text-3xl sm:text-4xl tracking-tighter text-foreground" data-testid="emprestimos-title">
        ...
        <div className="bg-card rounded-xl ring-1 ring-border overflow-hidden" data-testid="emprestimos-table-container">
          {emprestimosFiltrados.length === 0 ? (
