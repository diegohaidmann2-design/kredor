...
class PlanoLimites(BaseModel):
    ...
    # Membros de equipe além do dono. 0 = nenhum, -1 = ilimitado. Antes a tela exibia um
    # "999" fixo no código, que não era limite nenhum — este campo é o número de verdade.
    max_membros: int = 0
