...
from .aceite_emprestimo import router as aceite_emprestimo_router
...
api_router.include_router(aceite_emprestimo_router, prefix="/aceite-emprestimo", tags=["Aceite de Empréstimo"])
