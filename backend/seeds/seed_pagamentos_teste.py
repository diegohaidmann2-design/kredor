...
async def main():
    ...
    for nome, telefone, valor, parcelas in cenarios:
        ...
        await db.emprestimos.insert_one({
            ...
            "valor_principal_centavos": valor,
            ...
            "valor_total_com_juros_centavos": valor * 1.2,
            "valor_total_juros_centavos": valor * 0.2,
            "status": "ativo",
            "created_at": datetime.now(timezone.utc).isoformat(),
        })
